...
public class KitapController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @PutMapping("/{id}")
    public Kitap kitapGuncelle(@PathVariable Integer id, @RequestBody Kitap kitap, @RequestParam Integer yazarId,@RequestParam  Integer kategoriId) {
        return kitapService.guncelle(id, kitap, yazarId,kategoriId);
    }
